...
class ResumeApp:
    ...
    def add_footer(self):
        ...
        with col2:
            ...
            <div style='display: flex; justify-content: center; align-items: center; margin-bottom: 10px;'>
                <a href='https://github.com/krish8924' target='_blank' style='text-decoration: none;'>
            ...
            <p style='text-align: center;'>
                ...
                <a href="https://www.linkedin.com/in/krushna-chaudhari-405934275/" target="_blank" style='text-decoration: none; color: #FFFFFF'>
                    <b>Krushna Chaudhari</b>
                </a>
            </p>
    ...
    current_name.replace(
        ...
        st.toast("Check out these repositories:(https://github.com/krish8924)", icon="ℹ️")
     ...
     "124852522.jpeg")
        ...
        st.markdown(f"""
            <div class="profile-section">
                ...
                <h2 class="profile-name">Krushna Chaudhari</h2>
                <p class="profile-title">Software Developer</p>
                <div class="social-links">
                    <a href="https://github.com/krish8924" class="social-link" target="_blank">
                        <i class="fab fa-github"></i>
                    </a>
                    <a href="https://www.linkedin.com/in/krushna-chaudhari-405934275/" class="social-link" target="_blank">
                        <i class="fab fa-linkedin"></i>
                    </a>
                    <a href="chaudharikrushna885@gmail.com" class="social-link" target="_blank">
        ...
        st.toast("Check out these repositories: [Iriswise](https://github.com/krish8924)", icon="ℹ️")
